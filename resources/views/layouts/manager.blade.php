            ...
            @if(\Illuminate\Support\Facades\Auth::guard('manager')->check())
                <div class="dropdown text-end">
                    <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        {{\Illuminate\Support\Facades\Auth::guard('manager')->user()->name}}
                    </a>
                    <ul class="dropdown-menu text-small" style="">
                        <li><a class="dropdown-item" href="{{route('managerCategory')}}">Категории</a></li>
                        <li><a class="dropdown-item" href="{{route('managerProduct')}}">Продукты</a></li>
                        <li><a class="dropdown-item" href="{{route('managerBuyer')}}">Покупки</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <form action="{{route('managerLogout')}}" method="post">
                                @csrf
